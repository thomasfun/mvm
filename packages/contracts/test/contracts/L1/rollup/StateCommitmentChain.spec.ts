...
describe('StateCommitmentChain', () => {
  ...
  beforeEach(async () => {
    ...
    await AddressManager.setAddress(
<<<<<<< HEAD:packages/contracts/test/contracts/OVM/chain/OVM_StateCommitmentChain.spec.ts
      'OVM_ChainStorageContainer-SCC-batches',
=======
      'ChainStorageContainer-SCC-batches',
>>>>>>> 2c741af18943321173153180956f4bf84445a337:packages/contracts/test/contracts/L1/rollup/StateCommitmentChain.spec.ts
      batches.address
    )
